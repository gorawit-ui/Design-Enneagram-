  ...
  return <details className="share-link">
    ...
    <div className="share-link-body">
      ...
      <div>
        ...
        <p className="share-link-note">เปิดได้ทั้งมือถือและคอม ใช้เวลาประมาณ 10 นาที</p>
