...
export default function Home() {
  ...
  const restart = () => { setStep("welcome"); setProfile(INITIAL_PROFILE); setConsent(false); setIndex(0); setAnswers([]); setError(""); };
