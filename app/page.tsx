...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const onKey = (event: KeyboardEvent) => {
      ...
      const slot = ["a", "b", "c", "d"].indexOf(event.key.toLowerCase());
      if (slot >= 0) { event.preventDefault(); answer(slot); return; }
