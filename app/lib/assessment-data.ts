...
const AUTHORED_FOUNDATION: readonly AssessmentQuestion[] = [
  mbtiQuestion("f-ie-1", "เวลาคิด", "เมื่อเริ่มคิดเรื่องงาน คุณมักทำอะไรเป็นอย่างแรก?", "I", "E", ["คิดคนเดียวจนจบ แล้วค่อยบอกคนอื่น", "คิดเองเป็นหลัก แล้วเอาไปถามเช็คนิดหน่อย", "คุยกับคนอื่นเป็นหลัก แล้วค่อยมาเรียบเรียงเอง", "ต้องได้พูดออกมาถึงจะคิดออก"]),
  mbtiQuestion("f-ie-2", "พลังใจ", "หลังประชุมกับคนหลายคนต่อเนื่อง คุณมักทำอะไรต่อ?", "I", "E", ["อยากอยู่คนเดียวสักพัก ถึงจะกลับมาไหว", "ขอเวลาเงียบ ๆ หน่อย แล้วเจอคนต่อได้", "อยู่กับคนต่อได้ แต่ขอเป็นคนที่สนิท", "ยิ่งคุยต่อยิ่งได้พลังกลับมา"]),
  mbtiQuestion("f-sn-1", "รับข้อมูล", "เมื่อมีคนอธิบายงานใหม่ให้ฟัง คุณอยากได้อะไรก่อน?", "S", "N", ["ขอดูของจริงที่เคยทำมาก่อนเลย", "อยากได้ตัวอย่างเป็นหลัก ภาพใหญ่พอเข้าใจก็พอ", "อยากได้ภาพใหญ่เป็นหลัก ตัวอย่างพอให้เห็นก็พอ", "ขอรู้ก่อนว่างานนี้จะไปจบตรงไหน"]),
  mbtiQuestion("f-sn-2", "มองปัญหา", "เมื่อเจอปัญหาที่ยังไม่รู้สาเหตุ คุณเริ่มจากอะไร?", "S", "N", ["ไล่ดูทีละจุดว่าเกิดอะไรขึ้นบ้าง", "ไล่ของจริงเป็นหลัก เดาบ้างเวลาตัน", "เดาว่าน่าจะเพราะอะไรก่อน แล้วค่อยไปพิสูจน์", "รู้สึกได้เลยว่ามันน่าจะมาจากตรงไหน"]),
  mbtiQuestion("f-tf-1", "ตัดสินใจ", "เมื่อต้องเลือกระหว่างสองทางที่ดีพอกัน คุณมักยึดอะไรเป็นหลัก?", "T", "F", ["ตัดสินจากเกณฑ์ ใครจะรู้สึกยังไงเป็นอีกเรื่อง", "ยึดเกณฑ์เป็นหลัก แล้วค่อยดูว่ากระทบใครบ้าง", "ดูว่ากระทบใครก่อน แล้วค่อยเอาเกณฑ์มาจับ", "ถ้ามีคนเดือดร้อน เกณฑ์ก็ต้องขยับ"]),
  mbtiQuestion("f-tf-2", "ตัดสินใจเรื่องคน", "เมื่อต้องเลือกว่าใครควรได้โอกาสที่มีจำกัด คุณชั่งจากอะไร?", "T", "F", ["ดูผลงานอย่างเดียว ให้มันยุติธรรมกับทุกคน", "ดูผลงานเป็นหลัก แล้วค่อยดูว่าใครกำลังเจออะไรอยู่", "ดูว่าใครกำลังเจออะไรอยู่ก่อน แล้วค่อยดูผลงาน", "คนที่ต้องการมันมากกว่าควรได้ไปก่อน"]),
  mbtiQuestion("f-jp-1", "จัดการเวลา", "เมื่องานยังไม่เสร็จแต่เส้นตายใกล้เข้ามา คุณทำแบบไหน?", "J", "P", ["มีแผนอยู่แล้ว ก็เดินตามนั้นให้จบ", "เดินตามแผนเป็นหลัก ยอมปรับถ้าจำเป็นจริง ๆ", "ปรับหน้างานเป็นหลัก แต่มีเค้าโครงในหัวอยู่", "ไม่ยึดแผน เจออะไรก็ปรับไปตามนั้น"]),
  mbtiQuestion("f-jp-2", "วิธีเดินหน้า", "เมื่อได้รับงานที่ยังไม่มีใครเคยทำ คุณเริ่มยังไง?", "J", "P", ["วางขั้นตอนให้ครบก่อน ถึงจะเริ่มได้", "วางคร่าว ๆ พอเห็นทาง แล้วลงมือ", "ลงมือไปก่อน เดี๋ยวขั้นตอนมันชัดเอง", "ลองไปเรื่อย ๆ จนเจอวิธีที่ใช่"]),
  {
    id: "f-e-1", kind: "foundation", lens: "inward", context: "แรงขับภายใน", prompt: "เมื่อทำงานชิ้นหนึ่งเสร็จ อะไรทำให้คุณรู้สึกพอใจจากข้างในมากที่สุด?", options: [
      ...
      { text: "งานนั้นทำให้คนเห็นว่าเราทำได้", hint: "อยากให้ผลงานเป็นสิ่งที่ยืนยันว่าเราเก่งจริง", weights: { enneagram: { 3: 2 } } },
      { text: "งานนั้นสะท้อนความเป็นตัวเอง", hint: "อยากให้คนดูออกว่านี่เป็นงานของเรา ไม่ใช่ของใครก็ได้", weights: { enneagram: { 4: 2, 9: 1, 7: 1 } } },
    ],
  },
  {
    id: "f-e-2", kind: "foundation", lens: "outward", context: "ความมั่นคง", prompt: "เมื่อเจอความไม่แน่นอน อะไรช่วยให้คุณตั้งหลักได้มากที่สุด?", options: [
      { text: "รู้ว่ายังเป็นตัวเองได้อยู่", hint: "เรื่องเปลี่ยนได้ แต่ขออย่าให้ต้องกลายเป็นคนอื่น", weights: { enneagram: { 4: 2 } } },
      { text: "รู้ว่าเป้าหมายยังไม่เปลี่ยน", hint: "ขอแค่รู้ว่าวิ่งไปทางไหน เดี๋ยวจัดการได้", weights: { enneagram: { 3: 2 } } },
      { text: "รู้ว่ามีคนที่พึ่งกันได้", hint: "ไม่ได้กลัวตัวเรื่อง กลัวต้องเจอคนเดียว", weights: { enneagram: { 2: 2 } } },
      { text: "รู้ว่าอะไรคือสิ่งที่ถูกต้อง", hint: "มีหลักให้ยึดไว้ก่อน ที่เหลือค่อยว่ากัน", weights: { enneagram: { 1: 2 } } },
      { text: "รู้ว่ายังมีเรื่องใหม่ให้ลองอีก", hint: "ตราบใดที่ยังมีอะไรน่าสนุกรออยู่ ก็ยังไหว", weights: { enneagram: { 7: 2 } } },
      { text: "รู้ว่ารอบตัวยังปกติดีอยู่", hint: "ถ้าไม่มีอะไรกระเพื่อม ก็ตั้งหลักได้เอง", weights: { enneagram: { 9: 2 } } },
    ],
  },
  {
  ...
  {
    id: "f-e-4", kind: "foundation", lens: "outward", context: "ก่อนตัดสินใจ", prompt: "ก่อนจะตัดสินใจเรื่องใหญ่ คุณต้องมีอะไรอยู่ในมือก่อน?", options: [
      ...
      { text: "ทางเลือกที่ยังเปิดอยู่", hint: "ยิ่งมีหลายทางให้เลือก ยิ่งรู้สึกว่าไปต่อได้", weights: { enneagram: { 7: 2 } } },
  ...
  },
  {
    id: "f-e-5", kind: "foundation", lens: "outward", context: "เวลาตึงเครียด", prompt: "เมื่อเจอแรงกดดันในงาน ปฏิกิริยาแรกของคุณมักเป็นแบบใด?", options: [
      ...
      { text: "เข้าไปคุมสถานการณ์เอง", hint: "ขอเป็นคนตัดสินใจว่าจะเอายังไงต่อ", weights: { enneagram: { 8: 2, 3: 1 } } },
    ],
  },
  {
  ...
  },
  {
    id: "f-e-7", kind: "foundation", lens: "outward", context: "สิ่งที่มีความหมาย", prompt: "คำชื่นชมเรื่องใดมีความหมายกับคุณเป็นการส่วนตัวมากที่สุด?", options: [
      ...
      { text: "เป็นคนที่ใครก็นึกถึงเวลามีงานสำคัญ", hint: "อยากเป็นชื่อแรกที่คนนึกออกเมื่อมีงานใหญ่", weights: { enneagram: { 3: 2 } } },
      { text: "เป็นคนมีมุมมองเฉพาะตัว", hint: "อยากถูกมองว่าคิดในแบบที่ไม่มีใครคิด", weights: { enneagram: { 4: 2 } } },
    ],
  },
  {
    id: "f-e-8", kind: "foundation", lens: "inward", context: "สิ่งที่ต้องการ", prompt: "ครั้งล่าสุดที่คุณมีเวลาว่างจากภาระขึ้นมาหนึ่งวัน คุณใช้มันไปกับอะไร?", options: [
      { text: "อยู่กับความสนใจของตัวเอง", hint: "ใช้ไปกับเรื่องของตัวเอง โดยไม่ให้ใครมาเรียก", weights: { enneagram: { 5: 2 } } },
      { text: "เคลียร์ให้ไม่มีอะไรค้าง", hint: "พักได้จริงก็ต่อเมื่อไม่มีอะไรค้างอยู่", weights: { enneagram: { 6: 2 } } },
      { text: "มีอิสระไปลองสิ่งใหม่", hint: "ใช้วันว่างไปกับอะไรที่ยังไม่เคยทำ", weights: { enneagram: { 7: 2 } } },
      { text: "ได้พักโดยไม่ต้องตามใจใคร", hint: "ใช้เป็นวันที่ไม่ต้องปรับตัวเข้าหาใคร", weights: { enneagram: { 9: 2, 8: 1 } } },
    ],
  },
  {
    id: "f-e-9", kind: "foundation", lens: "outward", context: "เมื่อเห็นต่าง", prompt: "เมื่อทีมเห็นไม่ตรงกันในเรื่องงาน เรื่องนั้นมักจบลงแบบไหนเมื่อมีคุณอยู่ด้วย?", options: [
      ...
      { text: "จบด้วยข้อสรุปที่ตรวจสอบย้อนได้", hint: "มีข้อสรุปที่กลับมาอ้างอิงได้ทีหลัง", weights: { enneagram: { 1: 2 } } },
      { text: "จบเมื่อเข้าใจเหตุผลของทุกฝ่ายแล้ว", hint: "เรื่องยังไม่ถูกปิดถ้ายังไม่เข้าใจว่าทำไม", weights: { enneagram: { 5: 2 } } },
    ],
  },
  {
    id: "f-e-10", kind: "foundation", lens: "outward", context: "เมื่องานถูกแทรก", prompt: "เมื่อมีงานแทรกเข้ามากลางสัปดาห์ อะไรที่คุณมักยอมทิ้งเป็นอย่างสุดท้าย?", options: [
      { text: "สิ่งที่รับปากคนอื่นไว้", hint: "รับปากไปแล้วก็ต้องได้ ไม่ปล่อยให้ใครรอเปล่า", weights: { enneagram: { 2: 2 } } },
...
const AUTHORED_DIMENSION_CHALLENGES: readonly AssessmentQuestion[] = [
  ...
  dimensionChallenge("AT2", "เมื่อส่งงานไปแล้วยังไม่มีใครตอบกลับ ระหว่างรอคุณมักทำอะไร?", "A", "Turbulent", ["ไม่คิดอะไรต่อ ถือว่าจบแล้ว", "ไม่ได้กังวล แต่เตรียมคำตอบไว้เผื่อถูกถาม", "นึกขึ้นมาเป็นระยะว่าตรงนั้นโอเคไหม", "กลับไปเปิดดูงานนั้นซ้ำหลายรอบ"]),
] as const;
...
const AUTHORED_CORE_CHALLENGES: readonly AssessmentQuestion[] = [
  coreChallenge(1, "เมื่อพบว่างานไม่ตรงกับข้อตกลง เหตุผลหลักที่ทำให้คุณลงมือแก้คืออะไร?", [e("ปล่อยผ่านไม่ได้ ถ้ารู้ว่ามันไม่ถูก",{1:3}),e("ถ้าไม่แก้ตอนนี้ เดี๋ยวมีเรื่องตามมาอีก",{6:3}),e("ไม่อยากให้งานออกมาแล้วเสียชื่อ",{3:3}),e("ปล่อยไว้แล้วจะมีคนไม่พอใจกัน",{9:3})]),
  coreChallenge(2, "เวลาช่วยเพื่อนร่วมงาน อะไรสำคัญกับคุณจากข้างในมากที่สุด?", [e("รู้สึกว่าเขาต้องการเราจริง ๆ",{2:3}),e("ช่วยแล้วงานต้องออกมาถูกต้องด้วย",{1:3}),e("ช่วยแล้วทีมออกมาดูดีไปด้วยกัน",{3:3}),e("ช่วยแล้วไม่มีใครต้องมาขุ่นข้องกัน",{9:3})]),
  coreChallenge(3, "เมื่อทำเป้าหมายหนึ่งสำเร็จ อะไรมีความหมายกับคุณมากที่สุด?", [e("มีคนพูดถึงว่าเราทำได้",{3:3}),e("คนที่เราแคร์ได้ประโยชน์จากมัน",{2:3}),e("เรามีน้ำหนักพอจะผลักเรื่องต่อไปแล้ว",{8:3}),e("มันออกมาเป็นแบบที่มีแต่เราทำได้",{4:3})]),
  coreChallenge(4, "เมื่อแสดงความเห็นที่ต่างจากคนอื่น สิ่งที่คุณมักไม่ยอมทิ้งคืออะไร?", [e("ความรู้สึกจริง ๆ ของเรา ต่อให้ไม่มีใครเห็นด้วย",{4:3}),e("เวลาที่จะได้คิดเรื่องนี้เงียบ ๆ คนเดียว",{5:3}),e("ไม่อยากถูกจำว่าเป็นฝ่ายที่แพ้",{3:3}),e("ความรู้สึกว่ายังไม่ต้องทะเลาะกันก็ได้",{9:3})]),
  coreChallenge(5, "เมื่อเข้าใจเรื่องงานใหม่ได้ลึกแล้ว มันให้อะไรกับคุณ?", [e("รู้สึกว่าไม่ต้องพึ่งใครแล้ว",{5:3}),e("รู้สึกว่าเจออะไรก็รับมือได้",{6:3}),e("รู้สึกว่าเรื่องนี้มีความหมายกับเราจริง ๆ",{4:3}),e("เห็นเรื่องใหม่ ๆ ที่น่าไปต่ออีกเพียบ",{7:3})]),
  coreChallenge(6, "ก่อนเจองานที่ไม่แน่นอน การเตรียมตัวไว้ช่วยอะไรคุณมากที่สุด?", [e("มีทางสำรองไว้ ถ้าทางหลักพัง",{6:3}),e("ทำให้มันถูกได้ตั้งแต่แรก ไม่ต้องมาแก้",{1:3}),e("มีข้อมูลอยู่ในมือ ไม่ต้องไปถามใคร",{5:3}),e("พอมีใครต้องการ เราช่วยได้ทันที",{2:3})]),
  coreChallenge(7, "เมื่อมีทางเลือกใหม่ สิ่งใดทำให้คุณสนใจทางเลือกนั้นมากที่สุด?", [e("มันมีอะไรใหม่ให้ได้ลอง",{7:3}),e("มันทำให้เราเข้าใจอะไรเพิ่ม",{5:3}),e("มันทำให้เราคุมเกมได้เอง",{8:3}),e("มันเป็นโอกาสพิสูจน์ว่าเราทำได้อีกแบบ",{3:3})]),
  coreChallenge(8, "เมื่อต้องกำหนดขอบเขตกับคนอื่น เหตุผลใดสำคัญกับคุณมากที่สุด?", [e("เรื่องของเรา เราต้องเป็นคนตัดสินเอง",{8:3}),e("ถ้ายอมตรงนี้ หลักที่ยึดไว้ก็พังหมด",{1:3}),e("ไม่อยากให้คนมองว่าเราคุมงานตัวเองไม่ได้",{3:3}),e("ถ้าไม่กันไว้ คนที่เราดูแลจะโดนไปด้วย",{2:3})]),
  coreChallenge(9, "เมื่อการคุยเริ่มตึงเครียด คุณมักทำให้อะไรกลับมาก่อน?", [e("ให้ทุกคนเย็นลงก่อน เรื่องค่อยว่ากัน",{9:3}),e("ดึงกลับมาคุยบนหลักที่ตกลงกันไว้",{1:3}),e("ทำให้แต่ละคนรู้ว่ายังมีคนเข้าใจอยู่",{2:3}),e("ทำให้รู้ว่าต่อจากนี้จะเกิดอะไรขึ้นบ้าง",{6:3})]),
];
...
const WING_CHALLENGE_CONTENT: Record<EnneagramCore, { prompt: string; choices: readonly [string, string, string, string] }> = {
  1: { prompt: "เมื่ออยากรักษาความสงบและดูแลคนอื่นพร้อมกัน คุณมักทำอย่างไร?", choices: ["ทำให้เรื่องเย็นลงก่อน คนค่อยว่ากันทีหลัง", "เน้นให้เรื่องสงบ แต่ก็ดูแลคนไปด้วย", "เน้นดูแลคน แล้วบรรยากาศมันดีขึ้นเอง", "เข้าไปดูแลคนตรง ๆ ไม่ต้องรอให้เรื่องเย็น"] },
  2: { prompt: "เมื่อต้องรักษามาตรฐานและพางานถึงเป้าหมาย คุณมักทำอย่างไร?", choices: ["ยอมช้า แต่ต้องถูกต้อง", "เน้นให้ถูกก่อน แล้วค่อยเร่งให้ทัน", "เน้นให้ทันก่อน แล้วค่อยกลับมาเก็บให้เรียบร้อย", "ส่งให้ทันไว้ก่อน รายละเอียดว่ากันทีหลัง"] },
  3: { prompt: "เมื่อต้องดูแลคนอื่นและรักษาความเป็นตัวเอง คุณมักทำอย่างไร?", choices: ["ดูแลเขาก่อน ความรู้สึกเราเก็บไว้ได้", "เน้นดูแลเขา แต่ก็บอกความรู้สึกเราบ้าง", "เน้นบอกความรู้สึกเราตามจริง แล้วค่อยดูแลเขา", "บอกไปตามที่รู้สึกจริง แม้เขาจะไม่สบายใจ"] },
  4: { prompt: "เมื่อต้องพางานถึงเป้าหมายและทำความเข้าใจข้อมูล คุณมักทำอย่างไร?", choices: ["ลุยไปก่อน เดี๋ยวรู้เรื่องเอาหน้างาน", "เน้นเดินหน้า แต่เก็บข้อมูลไปด้วยระหว่างทาง", "เน้นทำความเข้าใจก่อน แล้วค่อยขยับ", "ยังไม่เริ่มจนกว่าจะเข้าใจมันจริง ๆ"] },
  5: { prompt: "เมื่อต้องรักษาความเป็นตัวเองและเตรียมรับความเสี่ยง คุณมักทำอย่างไร?", choices: ["เอาที่รู้สึกจริงไว้ก่อน ความเสี่ยงค่อยว่ากัน", "เน้นความรู้สึกตัวเอง แต่ก็ดูความเสี่ยงไว้บ้าง", "เน้นดูความเสี่ยงก่อน แล้วค่อยพูดถึงความรู้สึก", "เตรียมรับมือไว้ก่อน ความรู้สึกเอาไว้ทีหลัง"] },
  6: { prompt: "เมื่อต้องเข้าใจข้อมูลและเปิดรับทางเลือกใหม่ คุณมักทำอย่างไร?", choices: ["ขอเข้าใจให้ครบก่อน แล้วค่อยพูดถึงทางใหม่", "เน้นเข้าใจก่อน แต่ก็เปิดหูเปิดตาไว้", "เน้นลองทางใหม่ แล้วค่อยเก็บรายละเอียด", "อยากลองของใหม่ก่อน เข้าใจทีหลังก็ได้"] },
  7: { prompt: "เมื่อต้องเตรียมรับความเสี่ยงและตัดสินใจเอง คุณมักทำอย่างไร?", choices: ["ดูให้ครบก่อนว่าพลาดตรงไหนได้บ้าง", "เน้นดูความเสี่ยงก่อน แล้วค่อยเคาะ", "เน้นเคาะให้จบ แล้วค่อยไปจัดการความเสี่ยง", "เคาะเลย เดี๋ยวมีอะไรก็รับเอง"] },
  8: { prompt: "เมื่อต้องเปิดรับทางเลือกและรักษาความสงบ คุณมักทำอย่างไร?", choices: ["หาทางใหม่ ๆ ไว้ก่อน สนุกกว่า", "เน้นหาทางใหม่ แต่ไม่ให้ใครอึดอัด", "เน้นไม่ให้ใครอึดอัดก่อน แล้วค่อยหาทางใหม่", "ขอให้ทุกอย่างราบรื่นไว้ก่อน"] },
  9: { prompt: "เมื่อต้องตัดสินใจเองและรักษามาตรฐาน คุณมักทำอย่างไร?", choices: ["เคาะเองเลย ไม่ต้องรอใครอนุมัติ", "เน้นเคาะให้จบ แล้วค่อยเช็คว่าถูกตามหลักไหม", "เน้นเช็คให้ถูกตามหลักก่อน แล้วค่อยเคาะ", "ต้องถูกตามหลักก่อน ถึงจะเคาะได้"] },
};
...
export const ITEM_BANK_VERSION: string = (() => {
  // The WORDING is part of the version, not just the shape. It was not, and that was a hole the
  // calibration run would have fallen into: rewriting eight stems from "what would you like" to
  // "what do you actually do" changes what people answer and changes nothing the old hash could
  // see, so a code collected before the rewrite and one collected after would have carried the
  // same b= field and been pooled as though they came from the same instrument.
