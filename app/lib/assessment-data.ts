...
const AUTHORED_FOUNDATION: readonly AssessmentQuestion[] = [
  ...
  mbtiQuestion("f-ie-2", "พลังใจ", "หลังประชุมกับคนหลายคนต่อเนื่อง คุณมักทำอะไรต่อ?", "I", "E", ["พักตามลำพัง", "พักคนเดียว แล้วค่อยกลับไปหาคน", "อยู่กับคนสนิท แล้วค่อยแยกไปพัก", "ใช้เวลากับคนอื่นต่อ"]),
  mbtiQuestion("f-sn-1", "รับข้อมูล", "เมื่อมีคนอธิบายงานใหม่ให้ฟัง คุณอยากได้อะไรก่อน?", "S", "N", ["ตัวอย่างงานที่เคยทำจริง", "ตัวอย่างก่อน แล้วค่อยบอกภาพใหญ่", "ภาพใหญ่ก่อน แล้วค่อยยกตัวอย่าง", "ภาพว่างานนี้จะไปจบตรงไหน"]),
  mbtiQuestion("f-sn-2", "มองปัญหา", "เมื่อเจอปัญหาที่ยังไม่รู้สาเหตุ คุณเริ่มจากอะไร?", "S", "N", ["ไล่ดูสิ่งที่เกิดขึ้นจริงทีละจุด", "ไล่ของจริงก่อน แล้วค่อยเดา", "เดาสาเหตุก่อน แล้วค่อยไล่ของจริง", "ตั้งสมมติฐานว่าน่าจะเพราะอะไร"]),
  ...
  mbtiQuestion("f-tf-2", "ตัดสินใจเรื่องคน", "เมื่อต้องเลือกว่าใครควรได้โอกาสที่มีจำกัด คุณชั่งจากอะไร?", "T", "F", ["ผลงานที่วัดได้ตามเกณฑ์", "ดูเกณฑ์ก่อน แล้วค่อยดูสถานการณ์", "ดูสถานการณ์ก่อน แล้วค่อยดูเกณฑ์", "สถานการณ์ของแต่ละคนตอนนั้น"]),
  ...
  mbtiQuestion("f-jp-2", "วิธีเดินหน้า", "เมื่อได้รับงานที่ยังไม่มีใครเคยทำ คุณเริ่มยังไง?", "J", "P", ["วางขั้นตอนให้ครบก่อนลงมือ", "วางคร่าว ๆ แล้วค่อยลงมือ", "ลงมือก่อน แล้วค่อยจัดขั้นตอน", "ลองทำแล้วปรับไปเรื่อย ๆ"]),
  {
...
const AUTHORED_DIMENSION_CHALLENGES: readonly AssessmentQuestion[] = [
  ...
  dimensionChallenge("JP", "เมื่อเริ่มงานที่มีเวลาจำกัด คุณลงมือแบบไหน?", "J", "P", ["รู้ขั้นตอนก่อนลงมือ", "วางขั้นตอน แล้วเปิดทางให้ปรับ", "เริ่มจากวิธีที่ปรับได้ แล้วค่อยวางแผน", "ลงมือโดยเปิดทางให้ปรับ"]),
