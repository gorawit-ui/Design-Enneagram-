...
const AUTHORED_CORE_CHALLENGES: readonly AssessmentQuestion[] = [
  coreChallenge(1, "เมื่อพบว่างานไม่ตรงกับข้อตกลง เหตุผลหลักที่ทำให้คุณลงมือแก้คืออะไร?", [e("รักษามาตรฐาน",{1:3}),e("เพิ่มความแน่นอน",{6:3}),e("ไม่อยากให้งานออกมาเสียชื่อ",{3:3}),e("คลี่คลายความตึงเครียด",{9:3})]),
  coreChallenge(2, "เวลาช่วยเพื่อนร่วมงาน อะไรสำคัญกับคุณจากข้างในมากที่สุด?", [e("รู้สึกเชื่อมโยงกัน",{2:3}),e("ทำตามหลักที่ยึดถือ",{1:3}),e("ให้ทีมออกมาดูดีไปด้วยกัน",{3:3}),e("รักษาบรรยากาศที่สงบ",{9:3})]),
  coreChallenge(3, "เมื่อทำเป้าหมายหนึ่งสำเร็จ อะไรมีความหมายกับคุณมากที่สุด?", [e("ได้รับการยอมรับว่าเราทำได้",{3:3}),e("เห็นว่าคนสำคัญได้ประโยชน์",{2:3}),e("มีน้ำหนักพอจะผลักเรื่องต่อไป",{8:3}),e("ได้แสดงความเป็นตัวเอง",{4:3})]),
  coreChallenge(4, "เมื่อแสดงความเห็นที่ต่างจากคนอื่น สิ่งที่คุณมักไม่ยอมทิ้งคืออะไร?", [e("ความรู้สึกที่ตรงกับตัวเอง",{4:3}),e("เวลาสำหรับคิดด้วยตัวเอง",{5:3}),e("ผลที่งานจะสร้างได้",{3:3}),e("บรรยากาศที่ยังไม่ต้องปะทะกัน",{9:3})]),
  coreChallenge(5, "เมื่อเรียนรู้เรื่องงานใหม่ การเข้าใจให้ลึกให้อะไรกับคุณมากที่สุด?", [e("พร้อมพึ่งพาตัวเอง",{5:3}),e("รับมือความเสี่ยงได้",{6:3}),e("เห็นความหมายของเรื่องนั้น",{4:3}),e("พบสิ่งใหม่ให้สำรวจ",{7:3})]),
  coreChallenge(6, "ก่อนเจองานที่มีความไม่แน่นอน การเตรียมพร้อมตอบความต้องการใดของคุณมากที่สุด?", [e("มีแผนสำรองให้อ้างอิง",{6:3}),e("ทำให้มันถูกตั้งแต่แรก",{1:3}),e("มีข้อมูลพร้อมใช้งาน",{5:3}),e("ช่วยคนอื่นได้เมื่อจำเป็น",{2:3})]),
  coreChallenge(7, "เมื่อมีทางเลือกใหม่ สิ่งใดทำให้คุณสนใจทางเลือกนั้นมากที่สุด?", [e("มีอะไรใหม่ให้ได้ลอง",{7:3}),e("ได้เข้าใจมากขึ้น",{5:3}),e("ได้กำหนดทางด้วยตัวเอง",{8:3}),e("ได้พิสูจน์ว่าเราทำได้อีกแบบ",{3:3})]),
  coreChallenge(8, "เมื่อต้องกำหนดขอบเขตกับคนอื่น เหตุผลใดสำคัญกับคุณมากที่สุด?", [e("รักษาสิทธิ์ตัดสินใจเอง",{8:3}),e("รักษาหลักที่ยึดถือ",{1:3}),e("รักษาภาพที่คนมองเราไว้",{3:3}),e("รักษาคนที่ต้องดูแล",{2:3})]),
  coreChallenge(9, "เมื่อการคุยเริ่มตึงเครียด คุณมักทำให้อะไรกลับมาก่อน?", [e("ให้ทุกฝ่ายเย็นลงก่อน",{9:3}),e("กลับมาคุยตามหลักที่ชัดเจน",{1:3}),e("ความสัมพันธ์ยังเชื่อมโยงกัน",{2:3}),e("สถานการณ์กลับมาคาดการณ์ได้",{6:3})]),
];
