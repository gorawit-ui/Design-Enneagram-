...
const AUTHORED_FOUNDATION: readonly AssessmentQuestion[] = [
  ...
  mbtiQuestion("f-sn-1", "รับข้อมูล", "เมื่อเริ่มงานที่ไม่คุ้นเคย คุณมักหาอะไรก่อน?", "S", "N", ["เริ่มจากรายละเอียดจริง", "ดูรายละเอียด แล้วค่อยมองภาพรวม", "มองภาพรวม แล้วค่อยดูรายละเอียด", "เริ่มจากภาพรวมข้างหน้า"]),
...
const AUTHORED_CORE_CHALLENGES: readonly AssessmentQuestion[] = [
  ...
  coreChallenge(4, "เมื่อแสดงความเห็นที่ต่างจากคนอื่น สิ่งที่คุณมักไม่ยอมทิ้งคืออะไร?", [e("ความรู้สึกที่ตรงกับตัวเอง",{4:3}),e("เวลาสำหรับคิดด้วยตัวเอง",{5:3}),e("ผลที่งานจะสร้างได้",{3:3}),e("สิทธิ์ที่จะไม่คล้อยตาม",{9:3})]),
  ...
  coreChallenge(9, "เมื่อการคุยเริ่มตึงเครียด คุณมักทำให้อะไรกลับมาก่อน?", [e("แต่ละฝ่ายยังเป็นตัวเองได้",{9:3}),e("กลับมาคุยตามหลักที่ชัดเจน",{1:3}),e("ความสัมพันธ์ยังเชื่อมโยงกัน",{2:3}),e("สถานการณ์กลับมาคาดการณ์ได้",{6:3})]),
];
