...
const AUTHORED_CORE_CHALLENGES: readonly AssessmentQuestion[] = [
  coreChallenge(1, "เมื่อพบว่างานไม่ตรงกับข้อตกลง เหตุผลหลักที่ทำให้คุณลงมือแก้คืออะไร?", [e("รักษามาตรฐาน",{1:3}),e("เพิ่มความแน่นอน",{6:3}),e("พางานไปถึงเป้าหมาย",{3:3}),e("คลี่คลายความตึงเครียด",{9:3})]),
